...
uint256 hashGenesisBlock("0x027c5589f08c96b3324d90c62e1f20fe2f03a0940e142ab557909d3794e2bb10");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // MyKingCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "MyKingCoin Signed Message:\n";
...
{
    // MyKingCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 25000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 50000); // MyKingCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10800; // MyKingCoin: 3.5 days
static const int64 nTargetSpacing = 240; // MyKingCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // MyKingCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // MyKingCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // MyKingCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xda3cb3c0eb1465f4561698006255aadc6b4927a94660e370ee748b5857f7f139");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Mykingcoin from Mykingcrypto community";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("c3682be48320c11b7824546825cb27c758b602dd6bfa40aef419e095ba6bc5ea8e595bab323ee30b279141b5c96742bd0d506c74da03ad2a0a80e8574da5df8882") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1538647657;
        block.nBits    = 504365644;
        block.nNonce   = 4115795495;

        if (fTestNet)
        {
            block.nTime    = 1538647657;
            block.nNonce   = 902357704;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x04d949267cb51753f6ede07588db37bace6927b6cf9a2d49b3adad9e958d4ca5"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // MyKingCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MyKingCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MyKingCoinMiner : ProcessBlock, block not accepted");
    }
